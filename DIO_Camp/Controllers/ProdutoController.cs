...
namespace DIO_Camp.Controllers
{
    public class ProdutoController : Controller
    {
        private readonly DioCampDbContext _context;

        public ProdutoController(DioCampDbContext context)
        {
            _context = context;
        }
        ...
        {
            var dioCampDbContext = _context.Produto.Include(p => p.Categoria);
            return View(await dioCampDbContext.ToListAsync());
        }
